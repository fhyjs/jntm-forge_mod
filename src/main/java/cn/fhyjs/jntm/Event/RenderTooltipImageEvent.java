...
public abstract class RenderTooltipImageEvent extends Event
{
    ...
    public RenderTooltipImageEvent(@NotNull ChatImage chatImage, int x, int y, @Nonnull FontRenderer fr)
    {
     ...
     * <ul>
     * <li>{@link net.minecraftforge.client.event.RenderTooltipEvent.PostBackground}</li>
     * <li>{@link net.minecraftforge.client.event.RenderTooltipEvent.PostText}</li>
     * </ul>
     */
     ...
     */
    public static class PostBackground extends RenderTooltipImageEvent.Post
    {
     ...
     */
    public static class PostText extends RenderTooltipImageEvent.Post
    {
