...
public class RenderRegistryHandler {
    public static void register()
    {
        try {
            ...
            ResourceLocation a = Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("jntm:cxkimage", new DynamicTexture(ImageIO.read(Minecraft.getMinecraft().mcDefaultResourcePack.getInputStream(new ResourceLocation("minecraft:textures/gui/title/mojang.png")))));
            a=a;
        }
        catch (IOException exception){
            Jntm.logger.fatal(exception);
        }
    }
}
